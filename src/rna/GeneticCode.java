...
class GeneticCode {
	...
	private static double seedLength=0.99;//this is the chance of adding an additional command to the seed genes; it iterates until it gets lower than this value
